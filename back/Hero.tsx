        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="mt-6 text-lg leading-8 text-gray-400 max-w-xl">
              Passionate Product Leader with 15+ years of experience delivering
              SaaS, FinTech, Blockchain, Web3, Agritech and EdTech products
              from concept to successful market launch.
            </p>
            ...
            <motion.div
              ...
              className="mt-10 flex items-center gap-2 text-cyan-400"
            >
          ...
          >
            <div className="relative">
              ...
              >
                <h3 className="font-bold text-xl">CSPO</h3>
